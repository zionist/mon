...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contract.period_of_payment'
        db.alter_column(u'build_contract', 'period_of_payment', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

        # Changing field 'CopyContract.period_of_payment'
        db.alter_column(u'build_copycontract', 'period_of_payment', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

    def backwards(self, orm):

        # Changing field 'Contract.period_of_payment'
        db.alter_column(u'build_contract', 'period_of_payment', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'CopyContract.period_of_payment'
        db.alter_column(u'build_copycontract', 'period_of_payment', self.gf('django.db.models.fields.DateField')(null=True))
