...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Ground.gas_supply'
        db.delete_column(u'build_ground', 'gas_supply')

        # Deleting field 'Building.gas_supply'
        db.delete_column(u'build_building', 'gas_supply')
    ...
    def backwards(self, orm):
        # Adding field 'Ground.gas_supply'
        db.add_column(u'build_ground', 'gas_supply',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Building.gas_supply'
        db.add_column(u'build_building', 'gas_supply',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
