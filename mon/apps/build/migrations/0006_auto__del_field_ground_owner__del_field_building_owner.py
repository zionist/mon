...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'build_ground', 'owner_id')

        # Deleting field 'Building.owner'
        db.delete_column(u'build_building', 'owner_id')


    def backwards(self, orm):
        # Adding field 'Ground.owner'
        db.add_column(u'build_ground', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.CustomUser'], null=True, blank=True),
                      keep_default=False)
