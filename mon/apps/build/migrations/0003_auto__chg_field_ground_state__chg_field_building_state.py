...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'build_ground', 'state', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Building.state'
        db.alter_column(u'build_building', 'state', self.gf('django.db.models.fields.IntegerField')())
