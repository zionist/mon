...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ground.owner'
        db.add_column(u'build_ground', 'owner',
                      self.gf('django.db.models.fields.CharField')(max_length=2048, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Building.owner'
        db.add_column(u'build_building', 'owner',
                      self.gf('django.db.models.fields.CharField')(max_length=2048, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Building.flat_num'
        db.add_column(u'build_building', 'flat_num',
    ...
    def backwards(self, orm):
        # Deleting field 'Ground.owner'
        db.delete_column(u'build_ground', 'owner')

        # Deleting field 'Building.owner'
        db.delete_column(u'build_building', 'owner')

        # Deleting field 'Building.flat_num'
        db.delete_column(u'build_building', 'flat_num')
    ...
    models = {
        'build.building': {
            ...
            'owner': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'null': 'True', 'blank': 'True'}),
