...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CopyBuilding.ownership_num'
        db.add_column(u'build_copybuilding', 'ownership_num',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Building.ownership_num'
        db.add_column(u'build_building', 'ownership_num',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ground.ownership_num'
        db.add_column(u'build_ground', 'ownership_num',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CopyBuilding.ownership_num'
        db.delete_column(u'build_copybuilding', 'ownership_num')

        # Deleting field 'Building.ownership_num'
        db.delete_column(u'build_building', 'ownership_num')

        # Deleting field 'Ground.ownership_num'
        db.delete_column(u'build_ground', 'ownership_num')
    ...
    models = {
        'build.building': {
            ...
            'ownership_num': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
