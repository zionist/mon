...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ground.developer'
        db.alter_column(u'build_ground', 'developer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Developer'], null=True, on_delete=models.SET_NULL))
        # Deleting field 'CopyBuilding.building_state'
        db.delete_column(u'build_copybuilding', 'building_state')

        # Adding field 'CopyBuilding.flat_num'
        db.add_column(u'build_copybuilding', 'flat_num',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Ground.developer'
        db.alter_column(u'build_ground', 'developer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Developer'], null=True))
        # Adding field 'CopyBuilding.building_state'
        db.add_column(u'build_copybuilding', 'building_state',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CopyBuilding.flat_num'
        db.delete_column(u'build_copybuilding', 'flat_num')
