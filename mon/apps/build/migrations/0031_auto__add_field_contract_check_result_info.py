...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contract.check_result_info'
        db.add_column(u'build_contract', 'check_result_info',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contract.check_result_info'
        db.delete_column(u'build_contract', 'check_result_info')
