...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Building.developer'
        db.alter_column(u'build_building', 'developer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Developer'], null=True, on_delete=models.SET_NULL))
        # Adding field 'Contract.period_of_payment'
        db.add_column(u'build_contract', 'period_of_payment',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Building.developer'
        db.alter_column(u'build_building', 'developer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Developer'], null=True))
        # Deleting field 'Contract.period_of_payment'
        db.delete_column(u'build_contract', 'period_of_payment')
