...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contract.sign_date'
        db.delete_column(u'build_contract', 'sign_date')

        # Adding field 'Contract.date'
        db.add_column(u'build_contract', 'date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Contract.sign_date'
        db.add_column(u'build_contract', 'sign_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Contract.date'
        db.delete_column(u'build_contract', 'date')
