...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ground.gas_supply'
        db.alter_column(u'build_ground', 'gas_supply', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Building.gas_supply'
        db.alter_column(u'build_building', 'gas_supply', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Contract.gas_supply'
        db.alter_column(u'build_contract', 'gas_supply', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Ground.gas_supply'
        db.alter_column(u'build_ground', 'gas_supply', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Building.gas_supply'
        db.alter_column(u'build_building', 'gas_supply', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Contract.gas_supply'
        db.alter_column(u'build_contract', 'gas_supply', self.gf('django.db.models.fields.NullBooleanField')(null=True))
