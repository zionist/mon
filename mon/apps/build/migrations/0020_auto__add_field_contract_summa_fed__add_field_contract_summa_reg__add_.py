...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contract.summa_fed'
        db.add_column(u'build_contract', 'summa_fed',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Contract.summa_reg'
        db.add_column(u'build_contract', 'summa_reg',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CopyContract.summa_fed'
        db.add_column(u'build_copycontract', 'summa_fed',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CopyContract.summa_reg'
        db.add_column(u'build_copycontract', 'summa_reg',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contract.summa_fed'
        db.delete_column(u'build_contract', 'summa_fed')

        # Deleting field 'Contract.summa_reg'
        db.delete_column(u'build_contract', 'summa_reg')

        # Deleting field 'CopyContract.summa_fed'
        db.delete_column(u'build_copycontract', 'summa_fed')

        # Deleting field 'CopyContract.summa_reg'
        db.delete_column(u'build_copycontract', 'summa_reg')
