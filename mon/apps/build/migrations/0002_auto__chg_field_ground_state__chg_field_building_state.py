...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ground.state'
        db.alter_column(u'build_ground', 'state', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Building.state'
        db.alter_column(u'build_building', 'state', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Ground.state'
        db.alter_column(u'build_ground', 'state', self.gf('django.db.models.fields.IntegerField')(default=2))

        # Changing field 'Building.state'
        db.alter_column(u'build_building', 'state', self.gf('django.db.models.fields.IntegerField')(default=2))
