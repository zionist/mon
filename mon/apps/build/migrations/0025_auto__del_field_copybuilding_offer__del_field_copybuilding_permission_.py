...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CopyBuilding.offer'
        db.delete_column(u'build_copybuilding', 'offer')

        # Deleting field 'CopyBuilding.permission'
        db.delete_column(u'build_copybuilding', 'permission')

        # Adding field 'CopyBuilding.build_state'
        db.add_column(u'build_copybuilding', 'build_state',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CopyBuilding.build_year'
        db.add_column(u'build_copybuilding', 'build_year',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CopyBuilding.ownership_year'
        db.add_column(u'build_copybuilding', 'ownership_year',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CopyBuilding.ownership_doc_num'
        db.add_column(u'build_copybuilding', 'ownership_doc_num',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CopyBuilding.mo_fond_doc_date'
        db.add_column(u'build_copybuilding', 'mo_fond_doc_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CopyBuilding.mo_fond_doc_num'
        db.add_column(u'build_copybuilding', 'mo_fond_doc_num',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CopyBuilding.planing_floor'
        db.add_column(u'build_copybuilding', 'planing_floor',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CopyBuilding.floor'
        db.add_column(u'build_copybuilding', 'floor',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CopyBuilding.cad_sum'
        db.add_column(u'build_copybuilding', 'cad_sum',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Building.offer'
        db.delete_column(u'build_building', 'offer')

        # Deleting field 'Building.permission'
        db.delete_column(u'build_building', 'permission')

        # Adding field 'Building.build_state'
        db.add_column(u'build_building', 'build_state',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Building.build_year'
        db.add_column(u'build_building', 'build_year',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Building.ownership_year'
        db.add_column(u'build_building', 'ownership_year',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Building.ownership_doc_num'
        db.add_column(u'build_building', 'ownership_doc_num',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Building.mo_fond_doc_date'
        db.add_column(u'build_building', 'mo_fond_doc_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Building.mo_fond_doc_num'
        db.add_column(u'build_building', 'mo_fond_doc_num',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Building.planing_floor'
        db.add_column(u'build_building', 'planing_floor',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Building.floor'
        db.add_column(u'build_building', 'floor',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Building.cad_sum'
        db.add_column(u'build_building', 'cad_sum',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Ground.offer'
        db.delete_column(u'build_ground', 'offer')

        # Deleting field 'Ground.permission'
        db.delete_column(u'build_ground', 'permission')

        # Adding field 'Ground.build_state'
        db.add_column(u'build_ground', 'build_state',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ground.build_year'
        db.add_column(u'build_ground', 'build_year',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ground.ownership_year'
        db.add_column(u'build_ground', 'ownership_year',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ground.ownership_doc_num'
        db.add_column(u'build_ground', 'ownership_doc_num',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ground.mo_fond_doc_date'
        db.add_column(u'build_ground', 'mo_fond_doc_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ground.mo_fond_doc_num'
        db.add_column(u'build_ground', 'mo_fond_doc_num',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ground.planing_floor'
        db.add_column(u'build_ground', 'planing_floor',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ground.floor'
        db.add_column(u'build_ground', 'floor',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ground.cad_sum'
        db.add_column(u'build_ground', 'cad_sum',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CopyBuilding.offer'
        db.add_column(u'build_copybuilding', 'offer',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CopyBuilding.permission'
        db.add_column(u'build_copybuilding', 'permission',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CopyBuilding.build_state'
        db.delete_column(u'build_copybuilding', 'build_state')

        # Deleting field 'CopyBuilding.build_year'
        db.delete_column(u'build_copybuilding', 'build_year')

        # Deleting field 'CopyBuilding.ownership_year'
        db.delete_column(u'build_copybuilding', 'ownership_year')

        # Deleting field 'CopyBuilding.ownership_doc_num'
        db.delete_column(u'build_copybuilding', 'ownership_doc_num')

        # Deleting field 'CopyBuilding.mo_fond_doc_date'
        db.delete_column(u'build_copybuilding', 'mo_fond_doc_date')

        # Deleting field 'CopyBuilding.mo_fond_doc_num'
        db.delete_column(u'build_copybuilding', 'mo_fond_doc_num')

        # Deleting field 'CopyBuilding.planing_floor'
        db.delete_column(u'build_copybuilding', 'planing_floor')

        # Deleting field 'CopyBuilding.floor'
        db.delete_column(u'build_copybuilding', 'floor')

        # Deleting field 'CopyBuilding.cad_sum'
        db.delete_column(u'build_copybuilding', 'cad_sum')

        # Adding field 'Building.offer'
        db.add_column(u'build_building', 'offer',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Building.permission'
        db.add_column(u'build_building', 'permission',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Building.build_state'
        db.delete_column(u'build_building', 'build_state')

        # Deleting field 'Building.build_year'
        db.delete_column(u'build_building', 'build_year')

        # Deleting field 'Building.ownership_year'
        db.delete_column(u'build_building', 'ownership_year')

        # Deleting field 'Building.ownership_doc_num'
        db.delete_column(u'build_building', 'ownership_doc_num')

        # Deleting field 'Building.mo_fond_doc_date'
        db.delete_column(u'build_building', 'mo_fond_doc_date')

        # Deleting field 'Building.mo_fond_doc_num'
        db.delete_column(u'build_building', 'mo_fond_doc_num')

        # Deleting field 'Building.planing_floor'
        db.delete_column(u'build_building', 'planing_floor')

        # Deleting field 'Building.floor'
        db.delete_column(u'build_building', 'floor')

        # Deleting field 'Building.cad_sum'
        db.delete_column(u'build_building', 'cad_sum')

        # Adding field 'Ground.offer'
        db.add_column(u'build_ground', 'offer',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ground.permission'
        db.add_column(u'build_ground', 'permission',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Ground.build_state'
        db.delete_column(u'build_ground', 'build_state')

        # Deleting field 'Ground.build_year'
        db.delete_column(u'build_ground', 'build_year')

        # Deleting field 'Ground.ownership_year'
        db.delete_column(u'build_ground', 'ownership_year')

        # Deleting field 'Ground.ownership_doc_num'
        db.delete_column(u'build_ground', 'ownership_doc_num')

        # Deleting field 'Ground.mo_fond_doc_date'
        db.delete_column(u'build_ground', 'mo_fond_doc_date')

        # Deleting field 'Ground.mo_fond_doc_num'
        db.delete_column(u'build_ground', 'mo_fond_doc_num')

        # Deleting field 'Ground.planing_floor'
        db.delete_column(u'build_ground', 'planing_floor')

        # Deleting field 'Ground.floor'
        db.delete_column(u'build_ground', 'floor')

        # Deleting field 'Ground.cad_sum'
        db.delete_column(u'build_ground', 'cad_sum')
