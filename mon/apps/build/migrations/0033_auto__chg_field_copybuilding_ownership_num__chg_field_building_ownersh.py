...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CopyBuilding.ownership_num'
        db.alter_column(u'build_copybuilding', 'ownership_num', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

        # Changing field 'Building.ownership_num'
        db.alter_column(u'build_building', 'ownership_num', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

        # Changing field 'Ground.ownership_num'
        db.alter_column(u'build_ground', 'ownership_num', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

    def backwards(self, orm):

        # Changing field 'CopyBuilding.ownership_num'
        db.alter_column(u'build_copybuilding', 'ownership_num', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Building.ownership_num'
        db.alter_column(u'build_building', 'ownership_num', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Ground.ownership_num'
        db.alter_column(u'build_ground', 'ownership_num', self.gf('django.db.models.fields.DateField')(null=True))
