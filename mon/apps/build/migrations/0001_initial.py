...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'build_contractdocuments', (
        ...
        db.send_create_signal('build', ['ContractDocuments'])

        # Adding model 'Contract'
        db.create_table(u'build_contract', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('period_of_payment', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('mo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mo.MO'])),
            ('docs', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['build.ContractDocuments'], null=True, blank=True)),
        ))
        db.send_create_signal('build', ['Contract'])

        # Adding model 'Ground'
        db.create_table(u'build_ground', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('offer', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('permission', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('cad_passport', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('build', ['Ground'])

        # Adding model 'Building'
        db.create_table(u'build_building', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('approve_status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('state', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('address', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('offer', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('permission', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('flat_num', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('build', ['Building'])


    def backwards(self, orm):
        # Deleting model 'ContractDocuments'
        db.delete_table(u'build_contractdocuments')

        # Deleting model 'Contract'
        db.delete_table(u'build_contract')

        # Deleting model 'Ground'
        db.delete_table(u'build_ground')

        # Deleting model 'Building'
        db.delete_table(u'build_building')
