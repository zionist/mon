...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CopyContract'
        db.create_table(u'build_copycontract', (
            ...
            ('summ_mo_money', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('summ_without_mo_money', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('period_of_payment', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('creation_form', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
            ...
            ('budget', self.gf('django.db.models.fields.IntegerField')(max_length=1024, null=True)),
        ))
        db.send_create_signal('build', ['CopyContract'])


    def backwards(self, orm):
        # Deleting model 'CopyContract'
        db.delete_table(u'build_copycontract')
