...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CopyBuilding.driveway_num'
        db.add_column(u'build_copybuilding', 'driveway_num',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CopyBuilding.driveway_num'
        db.delete_column(u'build_copybuilding', 'driveway_num')
