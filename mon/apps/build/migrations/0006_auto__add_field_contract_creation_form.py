...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contract.creation_form'
        db.add_column(u'build_contract', 'creation_form',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contract.creation_form'
        db.delete_column(u'build_contract', 'creation_form')
