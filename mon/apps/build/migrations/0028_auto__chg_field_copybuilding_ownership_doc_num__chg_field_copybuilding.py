...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CopyBuilding.ownership_doc_num'
        db.alter_column(u'build_copybuilding', 'ownership_doc_num', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'CopyBuilding.mo_fond_doc_num'
        db.alter_column(u'build_copybuilding', 'mo_fond_doc_num', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))
        # Adding field 'Building.driveway_num'
        db.add_column(u'build_building', 'driveway_num',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Building.mo_fond_doc_num'
        db.alter_column(u'build_building', 'mo_fond_doc_num', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'Building.ownership_doc_num'
        db.alter_column(u'build_building', 'ownership_doc_num', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'Ground.ownership_doc_num'
        db.alter_column(u'build_ground', 'ownership_doc_num', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'Ground.mo_fond_doc_num'
        db.alter_column(u'build_ground', 'mo_fond_doc_num', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

    def backwards(self, orm):

        # Changing field 'CopyBuilding.ownership_doc_num'
        db.alter_column(u'build_copybuilding', 'ownership_doc_num', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CopyBuilding.mo_fond_doc_num'
        db.alter_column(u'build_copybuilding', 'mo_fond_doc_num', self.gf('django.db.models.fields.TextField')(null=True))
        # Deleting field 'Building.driveway_num'
        db.delete_column(u'build_building', 'driveway_num')


        # Changing field 'Building.mo_fond_doc_num'
        db.alter_column(u'build_building', 'mo_fond_doc_num', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Building.ownership_doc_num'
        db.alter_column(u'build_building', 'ownership_doc_num', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Ground.ownership_doc_num'
        db.alter_column(u'build_ground', 'ownership_doc_num', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Ground.mo_fond_doc_num'
        db.alter_column(u'build_ground', 'mo_fond_doc_num', self.gf('django.db.models.fields.TextField')(null=True))
