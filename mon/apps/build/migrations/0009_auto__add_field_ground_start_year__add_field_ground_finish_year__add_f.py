...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ground.start_year'
        db.add_column(u'build_ground', 'start_year',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 12, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Ground.finish_year'
        db.add_column(u'build_ground', 'finish_year',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 12, 0, 0), blank=True),
                      keep_default=False)
        ...
        # Adding field 'Building.start_year'
        db.add_column(u'build_building', 'start_year',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 12, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Building.finish_year'
        db.add_column(u'build_building', 'finish_year',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 12, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Building.cad_passport'
        db.add_column(u'build_building', 'cad_passport',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ground.start_year'
        db.delete_column(u'build_ground', 'start_year')

        # Deleting field 'Ground.finish_year'
        db.delete_column(u'build_ground', 'finish_year')

        # Deleting field 'Building.cad_num'
        db.delete_column(u'build_building', 'cad_num')

        # Deleting field 'Building.start_year'
        db.delete_column(u'build_building', 'start_year')

        # Deleting field 'Building.finish_year'
        db.delete_column(u'build_building', 'finish_year')

        # Deleting field 'Building.cad_passport'
        db.delete_column(u'build_building', 'cad_passport')
    ...
    models = {
        'build.building': {
            ...
            'finish_year': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 12, 0, 0)', 'blank': 'True'}),
            ...
            'start_year': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 12, 0, 0)', 'blank': 'True'}),
