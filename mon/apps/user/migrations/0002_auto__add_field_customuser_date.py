...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.date'
        db.add_column(u'user_customuser', 'date',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomUser.date'
        db.delete_column(u'user_customuser', 'date')
    ...
    models = {
        ...
        u'user.customuser': {
            ...
            'date': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
