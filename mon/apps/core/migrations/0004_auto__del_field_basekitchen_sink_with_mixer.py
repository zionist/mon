...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BaseKitchen.sink_with_mixer'
        db.delete_column(u'core_basekitchen', 'sink_with_mixer')


    def backwards(self, orm):
        # Adding field 'BaseKitchen.sink_with_mixer'
        db.add_column(u'core_basekitchen', 'sink_with_mixer',
