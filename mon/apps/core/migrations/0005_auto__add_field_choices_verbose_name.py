...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Choices.verbose_name'
        db.add_column(u'core_choices', 'verbose_name',
                      self.gf('django.db.models.fields.CharField')(max_length=2048, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Choices.verbose_name'
        db.delete_column(u'core_choices', 'verbose_name')
