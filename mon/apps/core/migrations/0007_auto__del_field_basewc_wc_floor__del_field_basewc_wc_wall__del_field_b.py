...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BaseWC.wc_floor'
        db.delete_column(u'core_basewc', 'wc_floor')

        # Deleting field 'BaseWC.wc_wall'
        db.delete_column(u'core_basewc', 'wc_wall')

        # Deleting field 'BaseWC.wc_ceiling'
        db.delete_column(u'core_basewc', 'wc_ceiling')

        # Adding field 'AuctionWC.wc_floor'
        db.add_column(u'core_auctionwc', 'wc_floor',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AuctionWC.wc_wall'
        db.add_column(u'core_auctionwc', 'wc_wall',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AuctionWC.wc_ceiling'
        db.add_column(u'core_auctionwc', 'wc_ceiling',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WC.wc_floor'
        db.add_column(u'core_wc', 'wc_floor',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'WC.wc_wall'
        db.add_column(u'core_wc', 'wc_wall',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'WC.wc_ceiling'
        db.add_column(u'core_wc', 'wc_ceiling',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BaseWC.wc_floor'
        db.add_column(u'core_basewc', 'wc_floor',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'BaseWC.wc_wall'
        db.add_column(u'core_basewc', 'wc_wall',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'BaseWC.wc_ceiling'
        db.add_column(u'core_basewc', 'wc_ceiling',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Deleting field 'AuctionWC.wc_floor'
        db.delete_column(u'core_auctionwc', 'wc_floor')

        # Deleting field 'AuctionWC.wc_wall'
        db.delete_column(u'core_auctionwc', 'wc_wall')

        # Deleting field 'AuctionWC.wc_ceiling'
        db.delete_column(u'core_auctionwc', 'wc_ceiling')

        # Deleting field 'WC.wc_floor'
        db.delete_column(u'core_wc', 'wc_floor')

        # Deleting field 'WC.wc_wall'
        db.delete_column(u'core_wc', 'wc_wall')

        # Deleting field 'WC.wc_ceiling'
        db.delete_column(u'core_wc', 'wc_ceiling')
