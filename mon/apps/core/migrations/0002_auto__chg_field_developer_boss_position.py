...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Developer.boss_position'
        db.alter_column(u'core_developer', 'boss_position', self.gf('django.db.models.fields.CharField')(default=1, max_length=2048))

    def backwards(self, orm):

        # Changing field 'Developer.boss_position'
        db.alter_column(u'core_developer', 'boss_position', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))
