...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Choice.num'
        db.add_column(u'core_choice', 'num',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Choice.value'
        db.add_column(u'core_choice', 'value',
                      self.gf('django.db.models.fields.CharField')(max_length=4096, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Choice.num'
        db.delete_column(u'core_choice', 'num')

        # Deleting field 'Choice.value'
        db.delete_column(u'core_choice', 'value')
