...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.approve_status'
        db.add_column(u'payment_payment', 'approve_status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.approve_status'
        db.delete_column(u'payment_payment', 'approve_status')
