...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Payment.pay_order'
        db.alter_column(u'payment_payment', 'pay_order', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Payment.pay_order'
        db.alter_column(u'payment_payment', 'pay_order', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
