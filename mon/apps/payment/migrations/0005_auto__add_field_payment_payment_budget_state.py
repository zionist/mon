...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.payment_budget_state'
        db.add_column(u'payment_payment', 'payment_budget_state',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.payment_budget_state'
        db.delete_column(u'payment_payment', 'payment_budget_state')
    ...
    models = {
        ...
        'payment.payment': {
            ...
            'payment_budget_state': ('django.db.models.fields.SmallIntegerField', [], {'default': '2'}),
