...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Payment.owner' to match new field type.
        db.rename_column(u'payment_payment', 'owner', 'owner_id')
        # Changing field 'Payment.owner'
        db.alter_column(u'payment_payment', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.CustomUser'], null=True))
        # Adding index on 'Payment', fields ['owner']
        db.create_index(u'payment_payment', ['owner_id'])


    def backwards(self, orm):
        # Removing index on 'Payment', fields ['owner']
        db.delete_index(u'payment_payment', ['owner_id'])


        # Renaming column for 'Payment.owner' to match new field type.
        db.rename_column(u'payment_payment', 'owner_id', 'owner')
        # Changing field 'Payment.owner'
        db.alter_column(u'payment_payment', 'owner', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))
