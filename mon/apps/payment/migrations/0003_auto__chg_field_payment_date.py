...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'payment_payment', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Payment.date'
        db.alter_column(u'payment_payment', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True))
