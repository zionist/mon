...
class MO(BaseName, ):
    ...
    creation_form = models.IntegerField(help_text=_(u"Форма создания специализированного жилого фонда"),
    ...
    home_orphans = models.IntegerField(blank=True, default=0, help_text=_(u"Количество сирот, которым предоставлено жильё"),
        verbose_name=_(u"Количество сирот, которым предоставлено жильё"))
