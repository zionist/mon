...
class PeopleAmount(models.Model):
    ...
    unhome_orphan = models.IntegerField(help_text=_(u"Численность детей-сирот в возрасте от 18 до 23 лет и старше 23 лет, которые до 1 января текущего года не реализовали свое право на получение жилого помещения в предыдущие годы (учитываются состоявшие и не состоявшие на льготном учете)."), null=True, verbose_name=_(u"Численность детей-сирот в возрасте от 18 до 23 лет и старше 23 лет, которые до 1 января текущего года не реализовали свое право на получение жилого помещения в предыдущие годы (учитываются состоявшие и не состоявшие на льготном учете)."), blank=True, )
