...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FederalBudget.subvention_performance'
        db.add_column(u'mo_federalbudget', 'subvention_performance',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DepartamentAgreement.subvention_performance'
        db.delete_column(u'mo_departamentagreement', 'subvention_performance')

        # Adding field 'RegionalBudget.subvention_performance'
        db.add_column(u'mo_regionalbudget', 'subvention_performance',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FederalBudget.subvention_performance'
        db.delete_column(u'mo_federalbudget', 'subvention_performance')

        # Adding field 'DepartamentAgreement.subvention_performance'
        db.add_column(u'mo_departamentagreement', 'subvention_performance',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'RegionalBudget.subvention_performance'
        db.delete_column(u'mo_regionalbudget', 'subvention_performance')
