...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subvention.amount'
        db.alter_column(u'mo_subvention', 'amount', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'FederalBudget.adm_coef'
        db.alter_column(u'mo_federalbudget', 'adm_coef', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'FederalBudget.sub_sum'
        db.alter_column(u'mo_federalbudget', 'sub_sum', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'FederalBudget.sub_orph_home'
        db.alter_column(u'mo_federalbudget', 'sub_orph_home', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'RegionalBudget.adm_coef'
        db.alter_column(u'mo_regionalbudget', 'adm_coef', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'RegionalBudget.sub_sum'
        db.alter_column(u'mo_regionalbudget', 'sub_sum', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'RegionalBudget.sub_orph_home'
        db.alter_column(u'mo_regionalbudget', 'sub_orph_home', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Subvention.amount'
        db.alter_column(u'mo_subvention', 'amount', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'FederalBudget.adm_coef'
        db.alter_column(u'mo_federalbudget', 'adm_coef', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'FederalBudget.sub_sum'
        db.alter_column(u'mo_federalbudget', 'sub_sum', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'FederalBudget.sub_orph_home'
        db.alter_column(u'mo_federalbudget', 'sub_orph_home', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'RegionalBudget.adm_coef'
        db.alter_column(u'mo_regionalbudget', 'adm_coef', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'RegionalBudget.sub_sum'
        db.alter_column(u'mo_regionalbudget', 'sub_sum', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'RegionalBudget.sub_orph_home'
        db.alter_column(u'mo_regionalbudget', 'sub_orph_home', self.gf('django.db.models.fields.IntegerField')(null=True))
