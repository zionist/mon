...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DepartamentAgreement.flats_amount'
        db.delete_column(u'mo_departamentagreement', 'flats_amount')


    def backwards(self, orm):
        # Adding field 'DepartamentAgreement.flats_amount'
        db.add_column(u'mo_departamentagreement', 'flats_amount',
