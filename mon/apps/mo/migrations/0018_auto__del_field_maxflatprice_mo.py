...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MaxFlatPrice.mo'
        db.delete_column(u'mo_maxflatprice', 'mo_id')


    def backwards(self, orm):
        # Adding field 'MaxFlatPrice.mo'
        db.add_column(u'mo_maxflatprice', 'mo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mo.MO'], null=True, blank=True),
                      keep_default=False)
