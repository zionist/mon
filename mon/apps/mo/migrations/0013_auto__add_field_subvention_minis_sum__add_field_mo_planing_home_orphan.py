...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subvention.minis_sum'
        db.add_column(u'mo_subvention', 'minis_sum',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MO.planing_home_orphans'
        db.add_column(u'mo_mo', 'planing_home_orphans',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FederalBudget.minis_sum'
        db.add_column(u'mo_federalbudget', 'minis_sum',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RegionalBudget.minis_sum'
        db.add_column(u'mo_regionalbudget', 'minis_sum',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subvention.minis_sum'
        db.delete_column(u'mo_subvention', 'minis_sum')

        # Deleting field 'MO.planing_home_orphans'
        db.delete_column(u'mo_mo', 'planing_home_orphans')

        # Deleting field 'FederalBudget.minis_sum'
        db.delete_column(u'mo_federalbudget', 'minis_sum')

        # Deleting field 'RegionalBudget.minis_sum'
        db.delete_column(u'mo_regionalbudget', 'minis_sum')
