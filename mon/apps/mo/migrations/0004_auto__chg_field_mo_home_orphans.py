...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MO.home_orphans'
        db.alter_column(u'mo_mo', 'home_orphans', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'MO.home_orphans'
        db.alter_column(u'mo_mo', 'home_orphans', self.gf('django.db.models.fields.IntegerField')(null=True))
