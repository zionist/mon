...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MO.creation_form'
        db.alter_column(u'mo_mo', 'creation_form', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=24, null=True))

    def backwards(self, orm):

        # Changing field 'MO.creation_form'
        db.alter_column(u'mo_mo', 'creation_form', self.gf('django.db.models.fields.IntegerField')(null=True))
