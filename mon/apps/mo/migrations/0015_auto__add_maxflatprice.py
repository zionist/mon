...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MaxFlatPrice'
        db.create_table(u'mo_maxflatprice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')()),
            ('max_price', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'mo', ['MaxFlatPrice'])


    def backwards(self, orm):
        # Deleting model 'MaxFlatPrice'
        db.delete_table(u'mo_maxflatprice')
