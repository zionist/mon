...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MO.planing_home_orphans'
        db.alter_column(u'mo_mo', 'planing_home_orphans', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'MO.planing_home_orphans'
        db.alter_column(u'mo_mo', 'planing_home_orphans', self.gf('django.db.models.fields.FloatField')(null=True))
