...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CopyAuction'
        db.create_table(u'cmp_copyauction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True, blank=True)),
            ('start_year', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 1, 1, 0, 0))),
            ('finish_year', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2018, 12, 31, 0, 0))),
            ...
            ('electric_supply', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=256, null=True, blank=True)),
            ('water_removal', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=256, null=True, blank=True)),
            ...
            ('heating', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=256, null=True, blank=True)),
        ...
        db.send_create_signal('cmp', ['CopyAuction'])


    def backwards(self, orm):
        # Deleting model 'CopyAuction'
        db.delete_table(u'cmp_copyauction')
    ...
    models = {
        ...
        'cmp.comparedata': {
            ...
            'area_cmp': ('django.db.models.fields.IntegerField', [], {'default': '1', 'null': 'True', 'blank': 'True'}),
            'clinic': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'cmp_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 27, 0, 0)', 'blank': 'True'}),
            'driveways': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'electric_supply': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'entrance_door': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'flats_amount': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
