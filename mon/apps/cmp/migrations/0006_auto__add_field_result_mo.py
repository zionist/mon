...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Result.mo'
        db.add_column(u'cmp_result', 'mo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mo.MO'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Result.mo'
        db.delete_column(u'cmp_result', 'mo_id')
