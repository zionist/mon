...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompareData.planing_floor'
        db.add_column(u'cmp_comparedata', 'planing_floor',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompareData.floor'
        db.add_column(u'cmp_comparedata', 'floor',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompareData.planing_floor'
        db.delete_column(u'cmp_comparedata', 'planing_floor')

        # Deleting field 'CompareData.floor'
        db.delete_column(u'cmp_comparedata', 'floor')
