...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Result.mo_pers'
        db.alter_column(u'cmp_result', 'mo_pers', self.gf('django.db.models.fields.CharField')(max_length=16384, null=True))

        # Changing field 'Result.establish_pers'
        db.alter_column(u'cmp_result', 'establish_pers', self.gf('django.db.models.fields.CharField')(max_length=16384, null=True))

    def backwards(self, orm):

        # Changing field 'Result.mo_pers'
        db.alter_column(u'cmp_result', 'mo_pers', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Result.establish_pers'
        db.alter_column(u'cmp_result', 'establish_pers', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'cmp.result': {
            ...
            'establish_pers': ('django.db.models.fields.CharField', [], {'max_length': '16384', 'null': 'True', 'blank': 'True'}),
            'finish_year': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2018, 12, 31, 0, 0)'}),
            ...
            'mo_pers': ('django.db.models.fields.CharField', [], {'max_length': '16384', 'null': 'True', 'blank': 'True'}),
            'readiness': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
