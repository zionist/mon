...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Auction.electric_supply'
        db.alter_column(u'cmp_auction', 'electric_supply', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'Auction.electric_supply'
        db.alter_column(u'cmp_auction', 'electric_supply', self.gf('django.db.models.fields.IntegerField')(null=True))
