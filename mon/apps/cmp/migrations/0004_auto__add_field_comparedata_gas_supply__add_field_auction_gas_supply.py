...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompareData.gas_supply'
        db.add_column(u'cmp_comparedata', 'gas_supply',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Auction.gas_supply'
        db.add_column(u'cmp_auction', 'gas_supply',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompareData.gas_supply'
        db.delete_column(u'cmp_comparedata', 'gas_supply')

        # Deleting field 'Auction.gas_supply'
        db.delete_column(u'cmp_auction', 'gas_supply')
    ...
    models = {
        ...
        'cmp.comparedata': {
            ...
            'area': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'clinic': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'cmp_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 9, 0, 0)', 'blank': 'True'}),
            'driveways': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'electric_supply': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'entrance_door': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'flats_amount': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
