...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Auction.start_year'
        db.add_column(u'cmp_auction', 'start_year',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Auction.finish_year'
        db.add_column(u'cmp_auction', 'finish_year',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Result.start_year'
        db.add_column(u'cmp_result', 'start_year',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Result.finish_year'
        db.add_column(u'cmp_result', 'finish_year',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 13, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Auction.start_year'
        db.delete_column(u'cmp_auction', 'start_year')

        # Deleting field 'Auction.finish_year'
        db.delete_column(u'cmp_auction', 'finish_year')

        # Deleting field 'Result.start_year'
        db.delete_column(u'cmp_result', 'start_year')

        # Deleting field 'Result.finish_year'
        db.delete_column(u'cmp_result', 'finish_year')
    ...
    models = {
        ...
        'cmp.comparedata': {
            ...
            'area_cmp': ('django.db.models.fields.IntegerField', [], {'default': '1', 'null': 'True', 'blank': 'True'}),
            'clinic': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'cmp_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 13, 0, 0)', 'blank': 'True'}),
            'driveways': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'electric_supply': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'entrance_door': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'flats_amount': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
