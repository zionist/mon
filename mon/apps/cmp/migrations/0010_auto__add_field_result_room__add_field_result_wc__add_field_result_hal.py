...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Result.room'
        db.add_column(u'cmp_result', 'room',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Room'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Result.wc'
        db.add_column(u'cmp_result', 'wc',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.WC'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Result.hallway'
        db.add_column(u'cmp_result', 'hallway',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Hallway'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Result.kitchen'
        db.add_column(u'cmp_result', 'kitchen',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Kitchen'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CompareData.hallway'
        db.delete_column(u'cmp_comparedata', 'hallway_id')

        # Deleting field 'CompareData.room'
        db.delete_column(u'cmp_comparedata', 'room_id')

        # Deleting field 'CompareData.kitchen'
        db.delete_column(u'cmp_comparedata', 'kitchen_id')

        # Deleting field 'CompareData.wc'
        db.delete_column(u'cmp_comparedata', 'wc_id')


    def backwards(self, orm):
        # Deleting field 'Result.room'
        db.delete_column(u'cmp_result', 'room_id')

        # Deleting field 'Result.wc'
        db.delete_column(u'cmp_result', 'wc_id')

        # Deleting field 'Result.hallway'
        db.delete_column(u'cmp_result', 'hallway_id')

        # Deleting field 'Result.kitchen'
        db.delete_column(u'cmp_result', 'kitchen_id')

        # Adding field 'CompareData.hallway'
        db.add_column(u'cmp_comparedata', 'hallway',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Hallway'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompareData.room'
        db.add_column(u'cmp_comparedata', 'room',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Room'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompareData.kitchen'
        db.add_column(u'cmp_comparedata', 'kitchen',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Kitchen'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompareData.wc'
        db.add_column(u'cmp_comparedata', 'wc',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.WC'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'cmp.comparedata': {
            ...
            'area_cmp': ('django.db.models.fields.IntegerField', [], {'default': '1', 'null': 'True'}),
            'clinic': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'cmp_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 20, 0, 0)', 'blank': 'True'}),
            'driveways': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'electric_supply': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'entrance_door': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'flats_amount': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
