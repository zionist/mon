...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'cmp_result', 'mo_pers_id')

        # Deleting field 'Result.establish_pers'
        db.delete_column(u'cmp_result', 'establish_pers_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'cmp_result', 'mo_pers',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='mo_pers', null=True, to=orm['cmp.Person'], blank=True),
                      keep_default=False)

        # Adding field 'Result.establish_pers'
        db.add_column(u'cmp_result', 'establish_pers',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='establish_pers', null=True, to=orm['cmp.Person'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'cmp.comparedata': {
            ...
            'area': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'clinic': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'cmp_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 28, 0, 0)', 'blank': 'True'}),
            'driveways': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'electric_supply': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'entrance_door': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'flats_amount': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
