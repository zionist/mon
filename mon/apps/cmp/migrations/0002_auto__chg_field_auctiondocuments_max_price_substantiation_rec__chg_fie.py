...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cmp_auctiondocuments', 'max_price_substantiation_rec', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'AuctionDocuments.notice_rec'
        db.alter_column(u'cmp_auctiondocuments', 'notice_rec', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'AuctionDocuments.technical_specification_rec'
        db.alter_column(u'cmp_auctiondocuments', 'technical_specification_rec', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'AuctionDocuments.mun_contract_project'
        db.alter_column(u'cmp_auctiondocuments', 'mun_contract_project', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'AuctionDocuments.notice'
        db.alter_column(u'cmp_auctiondocuments', 'notice', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'AuctionDocuments.max_price_substantiation'
        db.alter_column(u'cmp_auctiondocuments', 'max_price_substantiation', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'AuctionDocuments.technical_specification'
        db.alter_column(u'cmp_auctiondocuments', 'technical_specification', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'AuctionDocuments.mun_contract_project_rec'
        db.alter_column(u'cmp_auctiondocuments', 'mun_contract_project_rec', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Result.doc_files'
        db.alter_column(u'cmp_result', 'doc_files', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'AuctionDocuments.max_price_substantiation_rec'
        db.alter_column(u'cmp_auctiondocuments', 'max_price_substantiation_rec', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'AuctionDocuments.notice_rec'
        db.alter_column(u'cmp_auctiondocuments', 'notice_rec', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'AuctionDocuments.technical_specification_rec'
        db.alter_column(u'cmp_auctiondocuments', 'technical_specification_rec', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'AuctionDocuments.mun_contract_project'
        db.alter_column(u'cmp_auctiondocuments', 'mun_contract_project', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'AuctionDocuments.notice'
        db.alter_column(u'cmp_auctiondocuments', 'notice', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'AuctionDocuments.max_price_substantiation'
        db.alter_column(u'cmp_auctiondocuments', 'max_price_substantiation', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'AuctionDocuments.technical_specification'
        db.alter_column(u'cmp_auctiondocuments', 'technical_specification', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'AuctionDocuments.mun_contract_project_rec'
        db.alter_column(u'cmp_auctiondocuments', 'mun_contract_project_rec', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Result.doc_files'
        db.alter_column(u'cmp_result', 'doc_files', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        'cmp.auctiondocuments': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_price_substantiation': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'max_price_substantiation_rec': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'mun_contract_project': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'mun_contract_project_rec': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'notice': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'notice_rec': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'technical_specification': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'technical_specification_rec': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        'cmp.comparedata': {
            'Meta': {'object_name': 'CompareData'},
            'area': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'clinic': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'cmp_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 26, 0, 0)', 'blank': 'True'}),
            'driveways': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'electric_supply': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'entrance_door': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'flats_amount': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
