...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompareData.heating'
        db.add_column(u'cmp_comparedata', 'heating',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompareData.area_cmp'
        db.add_column(u'cmp_comparedata', 'area_cmp',
                      self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True),
                      keep_default=False)


        # Changing field 'CompareData.area'
        db.alter_column(u'cmp_comparedata', 'area', self.gf('django.db.models.fields.FloatField')(null=True))
        # Adding field 'Auction.heating'
        db.add_column(u'cmp_auction', 'heating',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Auction.area_cmp'
        db.add_column(u'cmp_auction', 'area_cmp',
                      self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Auction.water_removal'
        db.alter_column(u'cmp_auction', 'water_removal', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=256, null=True))

        # Changing field 'Auction.area'
        db.alter_column(u'cmp_auction', 'area', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):
        # Deleting field 'CompareData.heating'
        db.delete_column(u'cmp_comparedata', 'heating')

        # Deleting field 'CompareData.area_cmp'
        db.delete_column(u'cmp_comparedata', 'area_cmp')


        # Changing field 'CompareData.area'
        db.alter_column(u'cmp_comparedata', 'area', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Deleting field 'Auction.heating'
        db.delete_column(u'cmp_auction', 'heating')

        # Deleting field 'Auction.area_cmp'
        db.delete_column(u'cmp_auction', 'area_cmp')


        # Changing field 'Auction.water_removal'
        db.alter_column(u'cmp_auction', 'water_removal', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Auction.area'
        db.alter_column(u'cmp_auction', 'area', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'cmp.comparedata': {
            ...
            'area_cmp': ('django.db.models.fields.IntegerField', [], {'default': '1', 'null': 'True', 'blank': 'True'}),
            'clinic': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'cmp_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 4, 0, 0)', 'blank': 'True'}),
            'driveways': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'electric_supply': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'entrance_door': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'flats_amount': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
