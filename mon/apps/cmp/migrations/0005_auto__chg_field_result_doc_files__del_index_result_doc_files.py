...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Result.doc_files' to match new field type.
        db.rename_column(u'cmp_result', 'doc_files_id', 'doc_files')
        ...
        # Removing index on 'Result', fields ['doc_files']
        db.delete_index(u'cmp_result', ['doc_files_id'])


    def backwards(self, orm):
        # Adding index on 'Result', fields ['doc_files']
        db.create_index(u'cmp_result', ['doc_files_id'])


        # Renaming column for 'Result.doc_files' to match new field type.
        db.rename_column(u'cmp_result', 'doc_files', 'doc_files_id')
        # Changing field 'Result.doc_files'
        db.alter_column(u'cmp_result', 'doc_files_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['imgfile.File'], null=True))
    ...
    models = {
        ...
        'cmp.comparedata': {
            ...
            'area': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'clinic': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'cmp_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 11, 0, 0)', 'blank': 'True'}),
            'driveways': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'electric_supply': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'entrance_door': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'flats_amount': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
